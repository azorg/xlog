...
func Sprint(val any) string
    ...
    TintHandler'е. Если интерфейс имеет метод String, то для преобразования к
    строке используется он.
...
func NewMiddleware(mwf MiddlewareFunc) Middleware
    NewMiddleware создает новый Middleware на основе заданного метода-обёртки с
...
type Stringer interface {
    ...
    Типы данных соответствующему данному интерфейсу выводятся с помощью
    метода String() без рефлексии с помощью функции Sprint() при использовании
    TintHandler
